...
{
    template<>
    inline void RegisterMatrix<double, 3, 4, 4>::load(double beta, double const * ptr, size_t spacing)
    {
    ...
    template<>
    inline void RegisterMatrix<double, 3, 4, 4>::store(double * ptr, size_t spacing) const
    {
